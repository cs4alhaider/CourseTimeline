...
class WelcomeVC: BaseViewController {
    ...
    func setupWelcomeLabel() {
        ...
        text
            ...
            .bold("to timeline app", font: Identity.font(.custom(weight: .light, size: 19)), color: UIColor.Text.white)
    ...
    func setupCreateAccountLabel() {
        let text = NSMutableAttributedString()
        text
            .bold("Create a new account or sign in now", font: Identity.font(.custom(weight: .light, size: 25)), color: UIColor.Text.light)
